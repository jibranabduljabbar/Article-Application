...
class FavoritePost extends StatefulWidget {
  final Map data;
  FavoritePost({required this.data});
...
class _FavoritePostState extends State<FavoritePost> {
  ...
  //     db.collection("users/$uid/favorite").doc(data['id']).delete();
  //   }
  //   catch(e){
  //     print(e.toString());
  //   }
...
: ListTile(
  trailing: IconButton(icon: Icon(Icons.favorite_outlined,color: Colors.red), onPressed: (){
